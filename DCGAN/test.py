...
os.makedirs('images_CIFAR10/test/real', exist_ok=True)
os.makedirs('images_CIFAR10/test/fake', exist_ok=True)
...
parse.add_argument('--model_dir', type=str, default='images_CIFAR10/model/199_generated_image.pkl', help='save models here')
...
def main():
    ...
    for i, (image, labels) in enumerate(dataloader):
        ...
        save_image(gen_image.data, 'images_CIFAR10/test/fake/%d_generated_image.png' % (i), nrow=1, normalize=True)
        save_image(real_images.data, 'images_CIFAR10/test/real/%d_real_image.png' % i, nrow=1, normalize=True)

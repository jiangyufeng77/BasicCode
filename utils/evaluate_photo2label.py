...
parser.add_argument("--caffemodel_dir", type=str, default='/media/ouc/4T_A/jiang/pytorch_GAN/pytorch-CycleGAN-and-pix2pix/scripts/eval_cityscapes/caffemodel/', help="Where the FCN-8s caffemodel stored")
parser.add_argument("--gpu_id", type=int, default=2, help="Which gpu id to use")
...
#             os.makedirs(output_image_dir)
#     CS = cityscapes(args.cityscapes_dir)
#     CS.classes = ['unlabeled','ego vehicle','rectification border','out of roi','static','dynamic','ground','road','sidewalk',            'parking',
# 'rail track',
# 'building',
# 'wall',
# 'fence',
